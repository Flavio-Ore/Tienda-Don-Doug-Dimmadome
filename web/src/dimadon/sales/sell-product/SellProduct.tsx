...
import SaleCard from '@/dimadon/sales/sell-product/components/SaleCard'
import SellProductForm from '@/dimadon/sales/sell-product/components/SellProductForm'
import { useQueryAllSales } from '@/dimadon/sales/sell-product/hooks/useQueryAllSales'
