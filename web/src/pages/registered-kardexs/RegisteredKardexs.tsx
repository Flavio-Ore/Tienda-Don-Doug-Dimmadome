    ...
    <div className='common-container'>
      ...
      <div className='flex flex-col items-center w-full max-w-5xl gap-y-2 my-2'>
        <div className='flex items-center w-full max-w-5xl gap-y-6'>
          <h3 className='text-light-2 body-bold font-ubuntu'>Búsqueda global de Kardex</h3>
        </div>
      ...
      {kardexs.length === 0 && (
        <h2 className='text-light-2 text-2xl font-ubuntu'>No hay Kardex registrados</h2>
      )}

      {isTyping &&
        searchedKardexs.map(kardex => (
          <div key={kardex.id_kardex} className='flex flex-col p-5 gap-y-2'>
            <h2 className='text-xl font-ubuntu'>
              Producto:
